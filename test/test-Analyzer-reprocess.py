...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("/store/mc/PhaseIIMTDTDRAutumn18MiniAOD/NeutrinoGun_E_10GeV/MINIAODSIM/PU200_103X_upgrade2023_realistic_v2-v1/280000/260E6EA0-EDDF-5A46-8058-7D14AD4D103A.root"),

   secondaryFileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/PhaseIIMTDTDRAutumn18DR/NeutrinoGun_E_10GeV/FEVT/PU200_103X_upgrade2023_realistic_v2-v1/280000/CF7695FC-46FE-F649-9A7E-47ABE65D3861.root')
)

process.source.lumisToProcess = cms.untracked.VLuminosityBlockRange("1:1093","1:1094")
...
process.L1TauAnalyzer.l1PFObjects = cms.InputTag("l1pfCandidates","PF")
process.L1TauAnalyzer.l1TauObjects = cms.InputTag("L1PFTauProducer","L1PFTaus")
process.L1TauAnalyzer.L1TrackInputTag = cms.InputTag("TTTracksFromTracklet", "Level1TTTracks")
process.L1TauAnalyzer.genParticles = cms.InputTag("genParticles", "", "HLT")
process.L1TauAnalyzer.packedCandidates = cms.InputTag("packedPFCandidates")
process.L1TauAnalyzer.ecalTPGsBarrel = cms.InputTag("simEcalEBTriggerPrimitiveDigis","","HLT")
process.L1TauAnalyzer.miniTaus = cms.InputTag("slimmedTaus")
